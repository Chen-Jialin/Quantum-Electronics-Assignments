...
\begin{pf}
    ...
    \begin{align}
        ...
        \notag=&i\varkappa B_m^*e^{i(\beta_m^{\text{TM}}-\beta_m^{\text{TE}})z}A_m+A_m^*[-i\varkappa B_me^{-i(\beta_m^{\text{TM}}-\beta_m^{\text{TE}})z}]+i\kappa A_m^*e^{-i(\beta_m^{\text{TM}}-\beta_m^P\text{TE})z}B_m+B_m^*[-i\kappa A_me^{i(\beta_m^{\text{TM}}-\beta_m^{\text{TE}})z}]\\
        =&0,
    \end{align}
    即模式总功率守恒.
\end{pf}
